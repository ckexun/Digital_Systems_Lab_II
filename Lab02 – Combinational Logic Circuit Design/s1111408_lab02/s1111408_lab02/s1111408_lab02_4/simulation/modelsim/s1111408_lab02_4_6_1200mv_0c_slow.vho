...
ARCHITECTURE structure OF s1111408_lab02_4 IS
...
-- Equation(s):
-- \inst16~combout\ = (\I~input_o\ & (!\S0~input_o\ & !\S1~input_o\))
...
-- Equation(s):
-- \inst4~0_combout\ = (\I~input_o\ & (\S0~input_o\ & !\S1~input_o\))
...
-- Equation(s):
-- \inst4~1_combout\ = (\I~input_o\ & (!\S0~input_o\ & \S1~input_o\))
...
\inst4~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst4~2_combout\ = (\I~input_o\ & (\S0~input_o\ & \S1~input_o\))
