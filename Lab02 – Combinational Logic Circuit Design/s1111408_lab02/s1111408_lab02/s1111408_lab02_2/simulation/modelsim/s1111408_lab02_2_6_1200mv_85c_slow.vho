...
ARCHITECTURE structure OF s1111408_lab02_2 IS
...
-- Equation(s):
-- \inst12~0_combout\ = (\A3~input_o\) # ((\A7~input_o\) # ((\A6~input_o\) # (\A2~input_o\)))
...
-- Equation(s):
-- \inst13~0_combout\ = (\A4~input_o\) # ((\A7~input_o\) # ((\A6~input_o\) # (\A5~input_o\)))
