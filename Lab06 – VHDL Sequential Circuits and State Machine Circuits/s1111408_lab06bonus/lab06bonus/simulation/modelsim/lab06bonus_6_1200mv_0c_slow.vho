...
ARCHITECTURE structure OF lab06bonus IS
...
SIGNAL \Out_temp[0]~feeder_combout\ : std_logic;
SIGNAL \rst~input_o\ : std_logic;
SIGNAL \rst~inputclkctrl_outclk\ : std_logic;
SIGNAL \Out_temp[1]~feeder_combout\ : std_logic;
...
\Out_temp[0]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \Out_temp[0]~feeder_combout\ = \str_in~input_o\
...
PORT MAP (
	...
	combout => \Out_temp[0]~feeder_combout\);
...
\Out_temp[1]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \Out_temp[1]~feeder_combout\ = Out_temp(0)
...
PORT MAP (
	datad => Out_temp(0),
	combout => \Out_temp[1]~feeder_combout\);
...
-- Equation(s):
-- \Equal0~0_combout\ = (Out_temp(1) & (Out_temp(2) & !Out_temp(0)))
